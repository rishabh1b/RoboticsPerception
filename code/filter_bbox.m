...
% Function to get the best bounding boxes surrounding cars from the
% detection through two consecutive frames
...
bbox = [];
%Hack - If Detector provides a bbox within bbox only keep the outer one
bbox_1 = test_false_positive(bbox_1);
