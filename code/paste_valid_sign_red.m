function [chosen_bbox_arr, im, pos_train_ind_arr, right_pos_taken] = paste_valid_sign_red(bbox, im, classifier, sign_pos_arr, cell_size, max_error_score, size_train_image)
iter = size(bbox,1);
chosen_bbox = 0;
chosen_bbox_arr = [];
im_gray = rgb2gray(im);
